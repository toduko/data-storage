...
#define IS_WRITABLE_INT(id) ((id >= TYPE_S32_MIN_ID) && (id <= TYPE_S8_MAX_ID))
#define IS_STATIC_INT(id) (IS_STATIC_S32(id) || IS_STATIC_S16(id) || IS_STATIC_S8(id) || IS_STATIC_S32_MONO(id) || IS_STATIC_S16_MONO(id) || IS_STATIC_S8_MONO(id))
#define IS_INT(id) (IS_WRITABLE_INT(id) || IS_STATIC_INT(id))
#define IS_WRITABLE_STRING(id) ((id >= TYPE_STRING_MIN_ID) && (id <= TYPE_STRING_MAX_ID))
#define IS_GENERAL_STRING(id) (IS_WRITABLE_STRING(id) || IS_STATIC_STRING(id) || IS_STATIC_STRING_MONO(id))
#define IS_INT_LIST(id) ((id >= TYPE_S32_LIST_MIN_ID) && (id <= TYPE_S8_LIST_MAX_ID))
